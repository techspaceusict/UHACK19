/******/ (function(modules) {
  ...
  \***************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _scroll_entrance_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./scroll-entrance.min.js */ "./assets/js/scroll-entrance.min.js"
        );
        /* harmony import */ var _scroll_entrance_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
          _scroll_entrance_min_js__WEBPACK_IMPORTED_MODULE_0__
        );

        // set typed
        var typed = new Typed("#typed", {
          strings: ["Powered by HackDelhi"],
          typeSpeed: 30,
          backSpeed: 8,
          backDelay: 3500,
          startDelay: 1000,
        ...
        !(function() {
          (entrance = {}),
            ...
            (entrance.setInitialStyles = function(e) {
              ...
              (e.style.transition =
                "all " + entrance.duration / 1e3 + "s ease"),
                n && (e.style.transitionDelay = n / 1e3 + "s"),
                "fade" == t && (e.style.opacity = "0"),
                "from-left" == t &&
                  ((e.style.opacity = "0"),
                  (e.style.transform =
                    "translate(-" + entrance.distance + "px, 0)")),
                "from-right" == t &&
                  ((e.style.opacity = "0"),
                  (e.style.transform =
                    "translate(" + entrance.distance + "px, 0)")),
                "from-top" == t &&
                  ((e.style.opacity = "0"),
                  (e.style.transform =
                    "translate(0, -" + entrance.distance + "px)")),
                "from-bottom" == t &&
                  ((e.style.opacity = "0"),
                  (e.style.transform =
                    "translate(0, " + entrance.distance + "px)"));
            ...
            (entrance.init = function() {
              (entrance.elements = document.querySelectorAll(
                "[data-entrance]"
              )),
                Array.prototype.map.call(entrance.elements, function(e) {
